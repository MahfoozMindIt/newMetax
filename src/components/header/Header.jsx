...
<div className='flex gap-3'>
    ...
    <button className='rounded-full hidden md:block bg-[#542A74] hover:bg-[#7E489B] hover:border-[#7E489B] transition-all duration-300 text-white border-[#542A74] border-[2px] text-[16px] font-semibold py-2 px-10 cursor-pointer'>Contact us</button>
